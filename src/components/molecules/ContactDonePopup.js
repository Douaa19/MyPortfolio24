...
function ContactDonePopup(props) {
  return (
    <>
      <div
        class={`absolute ${
          props.light ? `bg-white` : `bg-dark`
        } opacity-80 inset-0 z-0`}></div>
      <div
        class={`w-500 max-w-xl px-5 py-10 flex justify-center relative bg-white mx-auto my-auto rounded-xl shadow-lg animation-fadeIn`}>
